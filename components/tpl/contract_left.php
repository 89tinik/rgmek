...
?>
<li>
    <a href="javascript:void(0);" class="<?= $activeClass ?>" data-name="<?= $contract['FullName'] ?>" data-uid="<?=$contract['UID']?>" cat="<?=$contract['Category']?>" data-odn="<?php echo (in_array($contract['Category'], ['2.3','4.2'])) ? 'true' :  'false';?>"><?= $contract['FullName'] ?><span>Какой-то текст никому не известно</span></a>
    <ul>
