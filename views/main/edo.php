...
$this->title = 'Электронный документооборот |  ЛК Р-Энергия';
...
<div class="box-tabs tabs">
    ...
    <div class="tab-items">
        <div class="tab-item" id="doc_tab_1" style="display: block;">
            <div class="text-box">
                <h3>Как перейти на электронный <br/>документооборот с ООО “Р-Энергия”</h3>
                <ol>
                    ...
                    <li>
                        Предоставьте заполненное соглашение в ООО “Р-Энергия” одним из способов:
                        <ul>
                            <li>принесите оригинал в двух экземплярах в офис ООО “Р-Энергия”</li>
                            <li>отправьте Вашей системой ЭДО с ЭЦП</li>
                        </ul>
                    </li>
                    <li>
                        Начните обмен документами через системы ЭДО (после того как соглашение будет подписано со стороны ООО “Р-Энергия”)
                    </li>
                </ol>
                <p>
                ...
                <ul>
                    ...
                    <li>Деловую переписку по договору электроснабжения</li>
                </ul>
                <p>
                ...
                <ul>
                    <li>в разделе <?= Html::a('Диалоги', ['messages/index'],['class'=>'ploader']) ?></li>
                    <li>по телефону 8(4912) 70-20-19 доб.231</li>
        ...
        <div class="tab-item" id="doc_tab_2" style="display: none;">
            <div class="text-box">
                ...
                <p>
                    ...
                    электроснабжения с ООО “Р-Энергия” на адрес электронной почты.
                </p>
                <p>
