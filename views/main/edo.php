    ...
    <div class="tab-items">
        <div class="tab-item" id="doc_tab_1" style="display: block;">
            <div class="text-box">
                ...
                <ol>
                    <li>Обратититесь в СКБ “Контур” (Дидок, ООО “Тензор” (СБИС) для подключения системы ЭДО</li>
                    ...
                    <li>
                        Начните обмен документами через системы ЭДО (после того как соглашение будет подписанно со
                        стороны ООО “РГМЭК”
                    </li>
                </ol>
                <p>
        ...
        <div class="tab-item" id="doc_tab_2" style="display: none;">
            <div class="text-box">
                ...
                <p>
                    ...
                    энергосбережения с ООО “РГМЭК” на адрес электронной почты.
                </p>
                <p>
                    Услуга предоставляется бесплатно.
                </p>
                <p>
                    На ваш адрес электронной почты Вы будете получаеть:
                </p>
                <ul>
                    <li>Счет на оплату</li>
                    <li>Детализацию счета</li>
                    <li>Деловую переписку по договору энергосбережения</li>
                </ul>
                <p>
                    <br/>
                </p>
