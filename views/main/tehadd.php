...
<div id="popap-info-tehadd"><p>Здесь потребуется прикрепить:</p><ul><li>файл договора или соглашения,</li><li>файл(ы) электронной подписи РГМЭК и заявителя.</li></ul><p>Подписание и направление акта допуска прибора учета и акта (уведомления) о тех. присоединении не требуется.</p>
</div>
