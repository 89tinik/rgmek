...
<div class="profile-left">
    ...
    <div class="info-warning">
        ...
        В случае обнаружения ошибок, а также при изменении контактной информации сообщить об этом в разделе <?=Html::a('Диалоги', ['messages/index'], ['class'=>'ploader']);?>
    </div>
</div>
...
<div class="profile-right">
    <div class="profile-status white-box">
        ...
        <div class="status-text">
            Вы можете настроить электронный документооборот с ООО “Р-Энергия” через специализированных операторов. Подробнее
    ...
    <div class="profile-status white-box">
        ...
        <div class="status-text">
            Вы можете подписаться на рассылку документов по договору энергоснабжения с ООО «Р-Энергия» на адрес электронной почты
        </div>
        <div class="status-control">
