...
use app\modules\ticket\assets\TicketAssets;

DefaultAssets::register($this);
IeAssets::register($this);
TicketAssets::register($this);
        ...
        <div class="fw">
            ...
            <header class="header">
                <div class="fw">
                    ...
                    <!-- logo -->
                    <div class="h-logo">
                        <a href="<?=\yii\helpers\Url::to(['/ticket'])?>" class="ploader">
                    ...
                    <div class="h-login">
                        ...
                        <?= Html::a(\Yii::$app->controller->userName, ['/ticket/logout'], ['class' => 'h-login-btn']) ?>
                        <?= Html::a('Выйти из аккаунта', ['/ticket/logout'], ['class' => 'h-login-btn-mobile']) ?>
                    </div>
